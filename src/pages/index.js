                ...
                <header className="mb-auto">
                    <div>
                        <nav className="nav nav-masthead justify-content-center">
                            ...
                            <Link className="nav-link bi bi-file-earmark-arrow-down-fill" to="/"> Download</Link>
                        </nav>
                    </div>
                </header>
                <main className="px-3">
                    ...
                    <div className="lead text-center container">
                        <h2>Download Now</h2>
                        <a className="btn btn-download m-1 btn-lg bi bi-file-earmark-arrow-down-fill" href="#"
